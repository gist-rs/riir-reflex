...
- run: `a2c03aa` on `4090-windows` (2026-09-25T03:09:08Z) · profile release · laya feature false
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 2000 | 0.3190 | 0.2270 | 0.0527 | 0.6924 | 1.2331 | 0.5525 | 0.4400 | 0.0805 | 0.82/0.93 | 0.3493 | 0.482 ms | 2.838 ms (5) | ✓ | s 0.0139 / d 0.9213 (n 100) |
| agentjev · AgentJev-0.6B@9d9b5fc3 | 2000 | 0.7715 | 0.7696 | 0.1082 | 0.3372 | 0.5771 | 0.1006 | 0.9030 | 0.1087 | — / — | — | 89.0 ms | 183.0 ms (5) | ✗ | — |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 400 | 0.5100 | 0.4725 | 0.2493 | 0.7419 | 1.3702 | 0.4899 | 0.5350 | 0.3797 | 0.49/0.26 | 0.5436 | 0.184 ms | 0.302 ms (5) | ✓ | s 0.0001 / d 0.3709 (n 200) |
| agentjev · AgentJev-0.6B@9d9b5fc3 | 400 | 0.8000 | 0.7804 | 0.1382 | 0.3153 | 0.6129 | 0.0828 | 0.9450 | 0.1382 | — / — | — | 31.0 ms | 39.0 ms (5) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 400 | 0.2825 | 0.1511 | 0.1128 | 0.8319 | 1.7874 | 0.7236 | 0.2850 | 0.0226 | 0.62/0.36 | 0.2773 | 0.102 ms | 0.156 ms (5) | ✓ | s 0.0000 / d 0.4153 (n 200) |
| agentjev · AgentJev-0.6B@9d9b5fc3 | 400 | 0.4225 | 0.3844 | 0.0534 | 0.6892 | 1.4363 | 0.4333 | 0.5600 | 0.0534 | — / — | — | 28.0 ms | 36.0 ms (5) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 600 | 0.2167 | 0.2044 | 0.0065 | 0.7988 | 1.6063 | 0.7849 | 0.2067 | 0.0165 | 0.57/0.32 | 0.2068 | 0.093 ms | 0.145 ms (7) | ✓ | s 0.0002 / d 0.3973 (n 200) |
| agentjev · AgentJev-0.6B@9d9b5fc3 | 600 | 0.4383 | 0.3315 | 0.0127 | 0.6750 | 1.2884 | 0.4929 | 0.5000 | 0.0127 | — / — | — | 31.0 ms | 38.0 ms (7) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 116 | 0.4397 | 0.4396 | 0.1070 | 0.5154 | 0.7086 | 0.5713 | 0.3966 | 0.1466 | 0.56/0.88 | 0.2143 | 0.050 ms | 0.079 ms (2) | ✓ | s 0.0004 / d 0.4079 (n 100) |
| agentjev · AgentJev-0.6B@9d9b5fc3 | 116 | 0.4828 | 0.3256 | 0.3831 | 0.7977 | 1.1769 | 0.5471 | 0.5172 | 0.3831 | — / — | — | 28.0 ms | 33.0 ms (2) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 300 | 0.3467 | 0.2151 | 0.0012 | 0.6674 | 1.0997 | 0.6898 | 0.3533 | 0.0965 | 0.64/0.38 | 0.3459 | 0.076 ms | 0.153 ms (4) | ✓ | s 0.0001 / d 0.5124 (n 200) |
| agentjev · AgentJev-0.6B@9d9b5fc3 | 300 | 0.4567 | 0.4403 | 0.1456 | 0.6494 | 1.0945 | 0.4555 | 0.5733 | 0.1456 | — / — | — | 31.0 ms | 47.0 ms (4) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 300 | 0.6900 | 0.6908 | 0.6227 | 0.9196 | 2.7260 | 0.1560 | 0.8667 | 0.0750 | 0.41/0.35 | 0.7268 | 0.072 ms | 0.110 ms (4) | ✓ | s 0.0621 / d 0.6319 (n 200) |
| agentjev · AgentJev-0.6B@9d9b5fc3 | 300 | 0.6233 | 0.6071 | 0.2886 | 0.6021 | 1.4595 | 0.1706 | 0.8133 | 0.2886 | — / — | — | 61.0 ms | 71.0 ms (4) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 500 | 0.4460 | 0.1515 | 0.4275 | 0.9778 | 4.0279 | 0.4253 | 0.5680 | 0.1810 | 1.00/0.23 | 0.5325 | 0.272 ms | 0.663 ms (6) | ✓ | s 0.0360 / d 0.4730 (n 200) |
| agentjev · AgentJev-0.6B@9d9b5fc3 | 500 | 0.5460 | 0.1858 | 0.3447 | 0.7382 | 2.1759 | 0.2078 | 0.7840 | 0.3447 | — / — | — | 149.0 ms | 162.0 ms (6) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 24 | 0.2500 | 0.0930 | 0.0806 | 0.6852 | 1.3719 | 0.6986 | 0.4167 | 0.2777 | 0.33/0.33 | 0.3750 | 0.151 ms | 0.233 ms (1, max@case8) | ✓ | s 0.0001 / d 0.2463 (n 36) |
| agentjev · AgentJev-0.6B@9d9b5fc3 | 24 | 0.3750 | 0.2814 | 0.2049 | 0.6899 | 1.3164 | 0.3885 | 0.5000 | 0.2049 | — / — | — | 85.0 ms | 162.0 ms (1, max@case0) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| agentjev · AgentJev-0.6B@9d9b5fc3 | 16 | 0.4375 | 0.3319 | 0.2041 | 0.6252 | 1.1198 | 0.4061 | 0.6250 | 0.2041 | — / — | — | 28.0 ms | 31.0 ms (1, max@case10) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| agentjev · AgentJev-0.6B@9d9b5fc3 | 12 | 0.4167 | 0.3111 | 0.4687 | 0.8024 | 1.2975 | 0.6458 | 0.5000 | 0.4687 | — / — | — | 28.0 ms | 29.0 ms (1, max@case0) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| agentjev · AgentJev-0.6B@9d9b5fc3 | 12 | 0.7500 | 0.6889 | 0.4819 | 0.6978 | 1.4591 | 0.0536 | 1.0000 | 0.4819 | — / — | — | 33.0 ms | 37.0 ms (1, max@case3) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| agentjev · AgentJev-0.6B@9d9b5fc3 | 16 | 0.3750 | 0.3111 | 0.1949 | 0.7372 | 1.3914 | 0.4697 | 0.5000 | 0.1949 | — / — | — | 28.0 ms | 30.0 ms (1, max@case9) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| agentjev · AgentJev-0.6B@9d9b5fc3 | 15 | 0.4000 | 0.3523 | 0.2073 | 0.7191 | 1.4153 | 0.3802 | 0.5714 | 0.2073 | — / — | — | 31.0 ms | 36.0 ms (1, max@case2) | ✗ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
