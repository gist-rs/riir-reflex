...
- run: `967415c` on `4090-windows` (2026-09-24T21:57:22Z) · profile release · laya feature true
...
- clm lane: on — the external Contrastive-LM reference over /v1/systemone (clm-serve; comparison lane, Apache-2.0, not affiliated): same cases, their rendering law, latency = client round-trip; determinism = the observed-repeat check
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 2000 | 0.3190 | 0.2270 | 0.0527 | 0.6924 | 1.2331 | 0.5525 | 0.4400 | 0.0805 | 0.82/0.93 | 0.3493 | 0.647 ms | 3.219 ms (5) | ✓ | s 0.0139 / d 0.9213 (n 100) |
| clm · clm-latest | 2000 | 0.3465 | 0.3454 | 0.4657 | 1.0086 | 2.4283 | 0.5977 | 0.3820 | 0.3846 | — / — | — | 66.0 ms | 109.0 ms (5) | ✓ | — |
...
**typed-decisions extras (clm·clm-latest):** soft_acc 0.3558 · brier_soft 0.5844 · score MAE 0.9175 · within_1 0.6088
| clm·clm-latest | choice | 600 | 0.2517 | 0.5765 | 0.8282 |
| clm·clm-latest | noul | 600 | 0.4650 | 0.2870 | 0.7520 |
| clm·clm-latest | score | 800 | 0.3287 | 0.5168 | 0.8455 |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 400 | 0.5100 | 0.4725 | 0.2493 | 0.7419 | 1.3702 | 0.4899 | 0.5350 | 0.3797 | 0.49/0.26 | 0.5436 | 0.191 ms | 0.489 ms (5) | ✓ | s 0.0001 / d 0.3709 (n 200) |
| clm · clm-latest | 400 | 0.4025 | 0.3588 | 0.2914 | 0.8586 | 2.1584 | 0.4329 | 0.5400 | 0.1984 | — / — | — | 33.0 ms | 39.0 ms (5) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 400 | 0.2825 | 0.1511 | 0.1128 | 0.8319 | 1.7874 | 0.7236 | 0.2850 | 0.0226 | 0.62/0.36 | 0.2773 | 0.107 ms | 0.210 ms (5) | ✓ | s 0.0000 / d 0.4153 (n 200) |
| clm · clm-latest | 400 | 0.2950 | 0.0944 | 0.3759 | 1.0980 | 4.8446 | 0.6125 | 0.3750 | 0.3097 | — / — | — | 31.0 ms | 35.0 ms (5) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 600 | 0.2167 | 0.2044 | 0.0065 | 0.7988 | 1.6063 | 0.7849 | 0.2067 | 0.0165 | 0.57/0.32 | 0.2068 | 0.097 ms | 0.223 ms (7) | ✓ | s 0.0002 / d 0.3973 (n 200) |
| clm · clm-latest | 600 | 0.2350 | 0.1656 | 0.5212 | 1.2170 | 3.9575 | 0.7557 | 0.2267 | 0.4619 | — / — | — | 31.0 ms | 36.0 ms (7) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 116 | 0.4397 | 0.4396 | 0.1070 | 0.5154 | 0.7086 | 0.5713 | 0.3966 | 0.1466 | 0.56/0.88 | 0.2143 | 0.051 ms | 0.140 ms (2) | ✓ | s 0.0004 / d 0.4079 (n 100) |
| clm · clm-latest | 116 | 0.5345 | 0.3793 | 0.2466 | 0.5953 | 0.8099 | 0.3278 | 0.6379 | 0.1559 | — / — | — | 32.0 ms | 38.0 ms (2) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 300 | 0.3467 | 0.2151 | 0.0012 | 0.6674 | 1.0997 | 0.6898 | 0.3533 | 0.0965 | 0.64/0.38 | 0.3459 | 0.088 ms | 0.194 ms (4) | ✓ | s 0.0001 / d 0.5124 (n 200) |
| clm · clm-latest | 300 | 0.6167 | 0.5559 | 0.0756 | 0.5401 | 0.9888 | 0.2583 | 0.7400 | 0.1961 | — / — | — | 32.0 ms | 37.0 ms (4) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 300 | 0.6900 | 0.6908 | 0.6227 | 0.9196 | 2.7260 | 0.1560 | 0.8667 | 0.0750 | 0.41/0.35 | 0.7268 | 0.073 ms | 0.141 ms (4) | ✓ | s 0.0621 / d 0.6319 (n 200) |
| clm · clm-latest | 300 | 0.2667 | 0.2616 | 0.1494 | 0.8766 | 2.5165 | 0.5855 | 0.3667 | 0.1232 | — / — | — | 31.0 ms | 80.0 ms (4) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 500 | 0.4460 | 0.1515 | 0.4275 | 0.9778 | 4.0279 | 0.4253 | 0.5680 | 0.1810 | 1.00/0.23 | 0.5325 | 0.301 ms | 0.675 ms (6) | ✓ | s 0.0360 / d 0.4730 (n 200) |
| clm · clm-latest | 500 | 0.0100 | 0.0106 | 0.2655 | 1.1070 | 5.7980 | 0.9967 | 0.0040 | 0.2559 | — / — | — | 31.0 ms | 37.0 ms (6) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 24 | 0.2500 | 0.0930 | 0.0806 | 0.6852 | 1.3719 | 0.6986 | 0.4167 | 0.2777 | 0.33/0.33 | 0.3750 | 0.171 ms | 0.266 ms (1, max@case8) | ✓ | s 0.0001 / d 0.2463 (n 36) |
| clm · clm-latest | 24 | 0.2917 | 0.0952 | 0.5509 | 1.0771 | 3.0748 | 0.8054 | 0.2500 | 0.5668 | — / — | — | 54.0 ms | 104.0 ms (1, max@case8) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 16 | 0.3750 | 0.3083 | 0.1994 | 0.7330 | 1.3525 | 0.4415 | 0.5000 | 0.3723 | 0.50/0.50 | 0.5000 | 0.008 ms | 0.017 ms (1, max@case6) | ✓ | s 0.0012 / d 0.7100 (n 20) |
| clm · clm-latest | 16 | 0.2500 | 0.1000 | 0.5826 | 1.1912 | 4.2306 | 0.5681 | 0.3750 | 0.5268 | — / — | — | 32.0 ms | 63.0 ms (1, max@case0) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 12 | 0.4167 | 0.3016 | 0.2232 | 0.6260 | 1.0380 | 0.3217 | 0.6667 | 0.3971 | 0.42/0.42 | 0.5714 | 0.006 ms | 0.006 ms (1, max@case0) | ✓ | s 0.0066 / d 0.3835 (n 18) |
| clm · clm-latest | 12 | 0.4167 | 0.3016 | 0.2071 | 0.8125 | 1.3719 | 0.7015 | 0.3333 | 0.2777 | — / — | — | 32.0 ms | 79.0 ms (1, max@case0) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| clm · clm-latest | 12 | 0.3333 | 0.3056 | 0.4264 | 0.8013 | 1.4527 | 0.5636 | 0.5000 | 0.4024 | — / — | — | 30.0 ms | 66.0 ms (1, max@case0) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| clm · clm-latest | 16 | 0.0625 | 0.0417 | 0.5693 | 1.0727 | 2.0137 | 0.9033 | 0.1250 | 0.4465 | — / — | — | 32.0 ms | 61.0 ms (1, max@case0) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
| lane · model | n | acc | macro F1 | ECE(maxp) | Brier | NLL | AURC | acc@50 | readout-ECE | abst(raw/cal) | sel-acc(cal) | p50 | p99 (support) | det | gate-fit (ρ=.30) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| modelless | 15 | 0.4000 | 0.3089 | 0.1557 | 0.7623 | 1.5144 | 0.4692 | 0.4286 | 0.3816 | 0.47/0.47 | 0.3750 | 0.007 ms | 0.011 ms (1, max@case0) | ✓ | s 0.0111 / d 0.4172 (n 20) |
| clm · clm-latest | 15 | 0.2000 | 0.0667 | 0.7628 | 1.5045 | 4.0311 | 0.6981 | 0.2857 | 0.7535 | — / — | — | 32.0 ms | 87.0 ms (1, max@case0) | ✓ | — |
| laya · (absent) | — the laya lane did not run for this suite (feature off / weights missing) — see absences above |
...
> modelless lane: SKIPPED — LLM-lane only (Issue 004 T3: the modelless lane has no KV cache; compile with `--features laya-riir`).

| lane · model | n | acc | ECE(maxp) | readout-ECE | p50 | p99 (support) | det |
|---|---|---|---|---|---|---|---|
| clm · clm-latest | 12 | 0.5000 | 0.2959 | 0.2875 | 32.0 ms | 85.0 ms (1, max@case0) | ✓ |
